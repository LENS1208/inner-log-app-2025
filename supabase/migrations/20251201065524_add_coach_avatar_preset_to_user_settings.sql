/*
  ...
  1. Changes
    - Add `coach_avatar_preset` column to `user_settings` table
      ...
      - Default value is 'teacher' (the standard coach)
      - Type: text
  
  2. Notes
    - This allows users to select from predefined coach avatar images
    - Available presets: 'teacher', 'beginner-coach', 'advanced-coach'
    - The selected avatar will be displayed in all coaching messages
*/
